        ...
        <div className="services section" id="services">
          ...
          <div className="services__container container">
            <div className="services__content">
              ...
              <div
                className={toggle === 1 ? "active-modal" : "services__modal"}
              >
                <div className="services__modal-content">
                  ...
                  <p className="services__modal-description">
                    I create responsive, user-friendly websites with HTML, CSS,
                    and JavaScript, offering WordPress customization and basic
                    SEO to establish a strong online presence.
                  </p>
            ...
            <div className="services__content">
              ...
              <div
                className={toggle === 2 ? "active-modal" : "services__modal"}
              >
                <div className="services__modal-content">
                  <i
                    className="uil uil-times services__modal-close"
